...
\begin{figure}[!htbp]
    ...
    \caption[RNN Unfold]{RNN Unfold \cite{wiki:rnns}}
    \label{fig:4.1}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \caption[LSTM Cell]{LSTM Cell \cite{wiki:lstm}}
    \label{fig:4.2}
\end{figure}
